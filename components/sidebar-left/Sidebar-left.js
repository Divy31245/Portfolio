    ...
    <main className="">
      ...
      >
        <div className="flex flex-col items-center justify-center py-10 text-4xl font-extrabold space-y-2">
          <Image
            src={
              "https://media-exp1.licdn.com/dms/image/C5603AQE_C8nH1c-Wbw/profile-displayphoto-shrink_400_400/0/1660202713680?e=1665619200&v=beta&t=xTQcTdaDwN-U6-ZZlRTlTRVC5WMxro0LhM9DqTiHWcs"
            }
            width={200}
            height={200}
            className={"rounded-full"}
